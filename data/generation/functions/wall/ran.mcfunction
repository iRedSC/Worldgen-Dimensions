...
execute unless score @s HR.ranSet < gen.wall.count config run scoreboard players set @s HR.ranSet 1
execute unless score @s HR.ran matches ..0 run function generation:wall/ran

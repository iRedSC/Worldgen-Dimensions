...
execute if entity @s[tag=decorL] unless score @s HR.ranSet < gen.decor.large.count config run scoreboard players set @s HR.ranSet 1
execute if entity @s[tag=decorM] unless score @s HR.ranSet < gen.decor.medium.count config run scoreboard players set @s HR.ranSet 1
execute if entity @s[tag=decorS] unless score @s HR.ranSet < gen.decor.small.count config run scoreboard players set @s HR.ranSet 1

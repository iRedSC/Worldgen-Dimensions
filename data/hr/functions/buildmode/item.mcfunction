give @s armor_stand{display:{Name:'{"text":"FC Marker","color":"aqua","bold":true,"italic":false}'},EntityTag:{Small:1b,Marker:1b,Invisible:1b,Tags:["fcMarker"]}} 1
give @s armor_stand{display:{Name:'{"text":"Wall Marker","color":"green","bold":true,"italic":false}'},EntityTag:{Small:1b,Marker:1b,Invisible:1b,Tags:["wallMarker"]}} 1
give @s armor_stand{display:{Name:'{"text":"Kill Hall Marker","color":"red","bold":true,"italic":false}'},EntityTag:{Small:1b,Marker:1b,Invisible:1b,Tags:["markerKill"]}} 1

...
execute if score @s HR.ranSet matches 6.. run scoreboard players set @s HR.ranSet 1
execute unless score @s HR.ran matches ..0 run function hr:directions/new-ran
execute if score @s HR.ran matches ..0 run function hr:directions/new
